    ...
    <!-- Add this code inside the <div id="content" class="p-4 p-md-5"> section -->
            ...
            <form action="{{ route('addArticle') }}" method="post">
              ...
              <div class="col form-group">
                ...
                <input class="form-control" type="datetime-local" id="published_at" name="published_at" required><br><br>
              </div>
              <div class="col form-group">
                <label >Upload Picture:</label>
                <input type="file" class="form-control" name="image" id="image"  accept="image/*" required><br><br>
              </div>
